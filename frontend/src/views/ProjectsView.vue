  ...
  <div>
    <div class="flex items-center justify-between mb-8">
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Gerencie seus projetos</p>
      </div>
    ...
    <div v-else-if="projectsStore.projects.length === 0" class="card p-12 text-center">
      ...
      <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">Nenhum projeto</h3>
    ...
    <div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-dark-800 rounded-xl shadow-xl w-full max-w-md mx-4">
        <div class="p-6 border-b border-gray-100 dark:border-dark-600">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Novo Projeto</h2>
        </div>
